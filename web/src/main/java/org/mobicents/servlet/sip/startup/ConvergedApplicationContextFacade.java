...
public class ConvergedApplicationContextFacade implements ServletContext {
     ...
     * @param appContext The AppliationContext object on which the method will be
     *            invoked
        ...
        try {
            ...
            if (method == null) {
                method = appContext.getClass().getMethod(methodName,
                        (Class[]) classCache.get(methodName));
     ...
     * @param context The AppliationContext object on which the method will be
     *            invoked
     * @param params The arguments passed to the called method.
     */
    private Object executeMethod(final Method method,
            final ConvergedApplicationContext context, final Object[] params)
    ...
    public Map<String, ServletRegistration> getServletRegistrations() {
        if (SecurityUtil.isPackageProtectionEnabled()) {
            return (Map<String, ServletRegistration>) doPrivileged(
                    "getServletRegistrations", new Object[] {});
        } else {
    ...
    public Map<String, FilterRegistration> getFilterRegistrations() {
        if (SecurityUtil.isPackageProtectionEnabled()) {
            return (Map<String, FilterRegistration>) doPrivileged(
                    "getFilterRegistrations", new Object[] {});
        } else {
    ...
    public Set<SessionTrackingMode> getDefaultSessionTrackingModes() {
        if (SecurityUtil.isPackageProtectionEnabled()) {
            return (EnumSet<SessionTrackingMode>) doPrivileged(
    ...
    /**
     * Use reflection to invoke the requested method. Cache the method object to
     * speed up the process will be invoked
     * @param methodName The method to call.
     * @param params The arguments passed to the called method.
     */
    ...
    private void handleException(Exception ex, String methodName)
        ...
        if (ex instanceof InvocationTargetException) {
            realException = ((InvocationTargetException) ex)
                    .getTargetException();
        } else {
            realException = ex;
        }
